...
\begin{enumerate}[itemsep=0.7cm]
    ...
    We can now solve simultaneously, eliminating functions.

    $\bigl[f(12)+f(11)\bigr]-\bigl[f(13)+f(12)\bigr]+\bigl[f(14)+f(13)\bigr]-\bigl[f(15)+f(14)\bigr]+...-\bigl[f(41)+f(40)\bigr]$

    $f(11)-f(41)=50-f(41)$

    $50-f(41)=12^2-13^2+14^2-15^2+...+40^2-41^2$
