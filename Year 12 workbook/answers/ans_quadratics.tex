...
\begin{enumerate}
    ...
    \)
    Therefore, \(x = -3 + 2\sqrt{2}, -3 - 2\sqrt{2}, \frac{1 + \sqrt{3}i}{2}, \frac{1 - \sqrt{3}i}{2}\)

    \item
    Set subject as \(\sqrt{x + 2}\)
    \(
    x + 2 - 10\sqrt{x+2} + 22 = 0\\
    {(\sqrt{x+2})}^2 - 10\sqrt{x+2} + 22\\
    u^2 - 10u + 22\\
    u = \frac{-10 \pm \sqrt{12}}{2} = -5 \pm 2\sqrt{3}\\
    \sqrt{x+2}=-5 \pm \sqrt{3}
    \)
    Solve for each separately:
    \(
    \sqrt{x+2}=-5 + \sqrt{3}\\
    x + 2 = 28 - 10\sqrt{3}\\
    x = 26 - 10\sqrt{3}\\
    ...
    x = 26 + 10\sqrt{3}\\
    \)
    So the solutions are \(x = 26 + 10\sqrt{3}, 26 - 10\sqrt{3}\)

    \item 
    Divide through by $x^2$:
    \(x^2 -4x - 10 -\frac{4}{x} +\frac{1}{x^2} = 0\)
    Gather the terms with same powers:
    \((x^2 + \frac{1}{x^2}) - 4(x + \frac{1}{x}) - 10 = 0\)
    Rewrite with $x + \frac{1}{x}$ as the subject:
    \(
    {(x + \frac{1}{x})}^2 - 2 - 4(x + \frac{1}{x}) - 10 = 0\\
    {(x + \frac{1}{x})}^2 - 4(x + \frac{1}{x}) - 12 = 0\\
    u = x+\frac{1}{x}\\
    u^2 - 4u - 12 = 0\\
    u = -2, 6
    \)
    ...
    x^2 + 1 = 6x\\
    x^2 -6x + 1=0\\
    x = \frac{6 \pm \sqrt{32}}{2} = 3 \pm 2\sqrt{2}
    \)
    Final solution is $x=-1, 3+2\sqrt{2}, 3-2\sqrt{2}$
\end{enumerate}
