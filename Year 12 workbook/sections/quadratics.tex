...
\begin{enumerate}
    ...
    \item Solve \(e^x - 20e^{-x} = 1\)
    
    \item Solve \(3^{2x+1} - 82\times 3^{x} +27 = 0\)
    
    \item Solve \(x^{\frac{1}{4}} +2x^{-\frac{1}{4}}=3\)
    
    \item Solve \(x^2 - 5x + 6 + \frac{5}{x} + \frac{1}{x^2} = 0\)
    
    \item Solve \(x - 10\sqrt{x+2} + 24 = 0\)
    
    \item Solve \(x^4 -4x^3 - 10x^2 -4x +1 = 0\)
